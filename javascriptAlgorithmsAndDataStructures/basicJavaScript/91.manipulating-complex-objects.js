...
/*   This is an array which contains one object inside. 
  ...
  In the example above, "artist": "Daft Punk" is a property 
  that has a key of artist and a value of Daft Punk.   */

// Exercise:
// Solution: Just add another object {}, with the same format.
const myMusic = [
    {
      "artist": "Billy Joel",
      "title": "Piano Man",
...
/* If you want to retrieve info from myMusic,
because it is firstly an Array, you will use
the brackets with index, 
and then the dot or backet for the object. */    
